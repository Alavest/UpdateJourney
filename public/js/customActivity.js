define([
    ...
    function initialize(data) {
        ...
        $.each(inArguments, function (index, inArgument) {
            $.each(inArgument, function (key, val) {
                ...
                if (key === 'LastNameInputvalue')
                {
                    $('#LastNameInput').val(val);
                }
            });
        });
    ...
    function save() {
        ...
        payload['arguments'].execute.inArguments = [{
            ...
            "tokens": authTokens,
            "emailAddress": "{{Contact.Attribute.EntradaJourney.Email}}",
            "FirstName": "{{Contact.Default.FirstName}}",
            "ID": "{{Event.APIEvent-97f1b4be-b316-18ce-ce7e-326da07a1f63.ID}}"
        }];
